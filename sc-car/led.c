...
/*-----------------------------------------------
  ...
  日期：2017.4.22
------------------------------------------------*/
void led_wirte_str(uchar ucIdxX, uchar ucIdxY, uchar ucDataStr[])
{
	
	LED_P8x16Str(ucIdxX, ucIdxY, ucDataStr);
}
...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void led_write_char(uchar ucIdxX, uchar ucIdxY, uchar ucData)
{
	// 写入字符
	LED_P6x8Char(ucIdxX, ucIdxY, ucData);	
}
...
/*****************************************************************************
 ...
 返 回 值  : none
*****************************************************************************/
void led_write_num(uchar ucIdxX, uchar ucIdxY, char cData)
{
   	// 写入数字
	LED_PrintChar(ucIdxX, ucIdxY, cData);
}
